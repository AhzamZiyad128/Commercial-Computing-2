...
<h3 class="w3-center">Verify Advertisements</h3>
  <div class="w3-row-padding w3-center" style="margin-top:64px">
    <div class="w3-quarter">   </div></div>   
    <center>
<?php
echo "<table style='border: solid 1px black;'>";
 echo "<tr><th>Id</th><th>Name</th><th>Brand</th><th>Model</th><th>Conditions</th><th>Price</th></tr>";
...
try {
    ...
    $stmt = $conn->prepare("SELECT id, fname, brand, model, conditions, price FROM images");
    $stmt->execute();
...
?>
  ...
  <a href="admin.php" ><h3 class="w3-center">Verify Users</h3></a>
  <div class="w3-row-padding w3-center" style="margin-top:64px">
